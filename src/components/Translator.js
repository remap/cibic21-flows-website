  ...
  function handleTranslation(e) {
    ...
    switch(e.target.id) {
      case "translate-english":
        ...
        aboutP3.textContent = `To learn more about getting involved with CiBiC please ${cibicLink}`;
        break;
      case "translate-spanish":
        ...
        aboutP2.textContent = "CiBiC is a collaborative research project led by UCLA and funded by the National Science Foundation. CiBiC studies how to support bicycle commuting.";
        aboutP3.textContent = "Para conocer más acerca de cómo participar en CiBiC ¡visita nuestro Website!";
        break;
      case "translate-chinese":
        ...
        aboutP2.textContent = "CiBiC is a collaborative research project led by UCLA and funded by the National Science Foundation. CiBiC studies how to support bicycle commuting.";
        aboutP3.textContent = "若您想瞭解更多有關參與 CiBiC 的資訊，請造訪我們的網站！";
        break;
    }
  }
